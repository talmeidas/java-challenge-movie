package io.github.talmeidas.movie.exception.handler;

import io.github.talmeidas.movie.entrypoint.rest.common.HttpResponseStatus;
...
public class GlobalExceptionHandler {
    ...
    public HttpResponseStatus handleAccessDeniedException(final AccessDeniedException exception, final Locale locale) {
        final String messageKey = StringUtils.isBlank(exception.getMessage()) ? "exception.access.denied" : exception.getMessage();
        final String message = messageSource.getMessage(messageKey, null, locale);
