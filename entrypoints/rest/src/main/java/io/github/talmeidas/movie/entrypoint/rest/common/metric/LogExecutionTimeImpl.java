package io.github.talmeidas.movie.entrypoint.rest.common.metric;
...
public class LogExecutionTimeImpl {
    ...
    @SneakyThrows
    @Around("@annotation(io.github.talmeidas.movie.entrypoint.rest.common.metric.LogExecutionTime)")
